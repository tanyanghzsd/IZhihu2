...
@SuppressLint("NewApi")
public class HotAdapter extends ArrayAdapter<HotNews>{
	...
	public HotAdapter(Context context, int resource, int textViewResourceId, List<HotNews> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		HotNews news = getItem(position);
		holder.title.setText(news.getTitle());
		/*
		 * 使用universal-image-loader对图片进行处理
		 */
		imageLoader.displayImage(news.getThumbnail(), holder.images, options);
		return convertView;
	}
	...
	public void refreshNewsList(List<HotNews> result) {
