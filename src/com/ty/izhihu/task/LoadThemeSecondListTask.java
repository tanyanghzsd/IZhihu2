...
public class LoadThemeSecondListTask extends AsyncTask<String, Void, List<News>>{
	private NewsAdapter mNewsAdapter;
	private OnFinishListener listener; 
	
	public LoadThemeSecondListTask(NewsAdapter newsAdapter) {
		// TODO Auto-generated constructor stub
		this.mNewsAdapter=newsAdapter;
	}
	
	public LoadThemeSecondListTask(NewsAdapter newsAdapter,OnFinishListener listener) {
		// TODO Auto-generated constructor stub
		this.mNewsAdapter=newsAdapter;
	...
	protected List<News> doInBackground(String... arg0) {
		...
		try {
			lists = JsonHelper.parseJsonToList(Http.getSecondThemeList(Integer.parseInt(arg0[0])));
		} catch (Exception e) {
